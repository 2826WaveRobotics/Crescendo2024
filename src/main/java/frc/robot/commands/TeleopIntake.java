...
public class TeleopIntake extends Command {
    ...
    public void execute() {
        ...
        VibrationFeedback.getInstance().setOverrideRight(transportState == TransportState.IntakingNote ? 0.6 : 0);
        VibrationFeedback.getInstance().setOverrideLeft(transportState == TransportState.MovingNote ? 0.6 : 0);
