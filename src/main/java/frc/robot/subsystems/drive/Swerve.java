    ...
    if (instance == null) {
      switch (Constants.currentMode) {
        case REAL:
          ...
          SwerveModuleIOSparkMax module0 = new SwerveModuleIOSparkMax(Constants.Swerve.mod0Constants);
          instance = new Swerve(
            new GyroIOPigeon2(),
            new SwerveModuleIO[] {
              module0,
            ...
            new EncoderIO[] {
              new EncoderIOSparkMaxAnalogEncoder(
                Constants.Swerve.mod0Constants,
                module0.turnSparkMax.getAnalog()
              ),
